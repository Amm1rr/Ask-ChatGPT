...
#DesignerProperty: Key: Value, DisplayName: Actual Value, FieldType: int, DefaultValue: 5, Description: Get o Set valute
...
Public Sub DesignerCreateView (Base As Panel, Lbl As Label, Props As Map)
	...
	If Props.ContainsKey("Value") Then Valore=Props.Get("Value") Else Valore=5
